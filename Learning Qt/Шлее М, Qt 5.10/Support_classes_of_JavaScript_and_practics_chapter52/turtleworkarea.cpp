...
TurtleWorkArea::TurtleWorkArea(QWidget *pwgt):QWidget(pwgt)
{
    ...
    lst<< "Haus vom Nukolaus" << "Curly" << "Circle" << "Fantasy";
    pcbo->addItems(lst);
    ...
    layout->addWidget(pcbo,0,0);
    layout->addWidget(m_ptxt,1,0);
    layout->addWidget(m_pTurtle,0,1,2,1);
    layout->addWidget(pcmd,2,0,1,2);
    setLayout(layout);
}
