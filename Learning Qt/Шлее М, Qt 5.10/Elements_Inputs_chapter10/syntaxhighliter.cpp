...
void SyntaxHighLiter::highlightBlock(const QString & str)
{
...
QString SyntaxHighLiter::getKeyword(int i, const QString &str) const
{
    QString strTemp = "";
...
SyntaxHighLiter::SyntaxHighLiter(QTextDocument *parent):QSyntaxHighlighter(parent)
{
    m_lstKeywords
